...
const search_stores_controller_1 = require("./controllers/search-stores.controller");
...
StoresModule = __decorate([
    common_1.Module({
        controllers: [search_stores_controller_1.SearchStoresController],
        providers: [search_stores_service_1.SearchStoresService],
    })
], StoresModule);
